...
module.exports = async (srv) => {
    ...
    srv.on('READ', 'SpHeaderSet', req => GMSCONTAPPROVAL_SRV.run(req.query));
    srv.on('READ', 'SPServproSet', req => GMSCONTAPPROVAL_SRV.run(req.query));
    srv.on('READ', 'SPCustomfldSet', req => GMSCONTAPPROVAL_SRV.run(req.query));
    srv.on('READ', 'SPClauseCodeSet', req => GMSCONTAPPROVAL_SRV.run(req.query));
